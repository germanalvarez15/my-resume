...
<div class="main-container-welcome">
    <div id="letter-object" class="text-pop-up-top">Welcome!</div>
    <button on:click="{onClick}" class="intro-button scale-up-center">About me</button>
</div>
...
.intro-button {
  ...
  border-bottom: 5px #00000026 solid;
}
